// kernels/vector_add/vector_add_naive.cu
...
// 3. CUDA kernel(s)
// =====================
__global__ void vector_add_gridstride_kernel(const int *A,
                                             const int *B,
                                             int *C,
                                             int N)
{
...
int main(int argc, char **argv)
{
    ...
    // ---- 6.5 warm-up ----
    vector_add_gridstride_kernel<<<grid, block>>>(d_A, d_B, d_C, N);
    ...
    std::printf("vector_add_v2_gridstride \n");
